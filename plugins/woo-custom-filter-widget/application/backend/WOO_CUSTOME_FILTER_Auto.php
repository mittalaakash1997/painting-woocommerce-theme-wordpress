<?php 
  ...
  $_category=array(
                array(
                    'thumb' => '',
                    'name' => 'Stone Type',
                    'description' => 'Stone type category',
                    'slug' => 'eo_stone_type_cat',
                    'child'=> 
                        array(
                            array(
                                'thumb' => $_img_url.'EO_WBC_Img/gemstone.jpeg',
                                'name' => 'Gem Stone',
                                'description' => 'Gem Stone',
                                'slug' => 'eo_diamond_gem_stone_cat'
                            ),
                            array(
                                'thumb' => $_img_url.'EO_WBC_Img/diamond.jpeg',
                                'name' => 'Diamond',
                                'description' => 'Deiamond',
                                'slug' => 'eo_diamond_diamond_stone_cat'
                            )                           
                        )
                ),
                array(
  ...
  if(!empty($_POST)) {
    ...
    if(isset($_POST['_wpnonce']) && wp_verify_nonce($_POST['_wpnonce'],'eo_wbc_auto_jewel')) {
      ...
      ////////////////////////////////////////////////////////////////////////
      require_once ('WOO_CUSTOME_FILTER_CatAt.php');
      $catat=new WOO_CUSTOME_FILTER_CatAt();
          ...
          if(!empty($category)){
            ...
            update_option('eo_wcfw_cats',serialize($catat_category));
          ...
          if(!empty($attributes)){
            ...
            update_option('eo_wcfw_attr',serialize($catat_attribute));
        ...
        jQuery(document).ready(function($) {            
            ...
            function eo_wbc_add_products(index){
                ...
                if(index>=eo_wbc_max_products){
                    ...
                    window.location.href="<?php echo(admin_url('admin.php?page=woo-custome-filter-config&tab=shop_cat_opt')); ?>";
                    return false;
                }
