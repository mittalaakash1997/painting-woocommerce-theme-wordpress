<h2>Add Filter Field<!-- Shortcode Generator --></h2>
	...
	<tbody>		
		...
		<tr>
			...
			<td class="forminp">
				...
				<br/>
				<span class="wcfw_help">( Just give it any relevant name.<!-- a unique name to form parent-child relationship. --> )</span>	
			</td>
		</tr>			
	</tbody>
</table>
...
<br/>
<br/>
<h2>Filter Fields<!-- Available Filters --></h2>
